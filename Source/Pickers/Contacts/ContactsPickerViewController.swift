...
public extension UIAlertController {
    ...
    func addContactsPicker(localizer: TelegramPickerResourceProvider? = nil, selection: @escaping ContactsPickerViewController.Selection) {
...
public final class ContactsPickerViewController: UIViewController {
    ...
    fileprivate lazy var searchView: UIView = .init()
    ...
    func checkStatus(completionHandler: @escaping ([String: [CNContact]]) -> ()) {
        ...
        case .denied, .restricted:
            ...
            alert.addAction(title: "OK".localized, style: .cancel) { [unowned self] _ in
    ...
    func fetchContacts(completionHandler: @escaping ([String: [CNContact]]) -> ()) {
        Contacts.fetchContactsGroupedByAlphabets { [unowned self] result in
            ...
            case .error(let error):
                ...
                alert.addAction(title: "OK".localized) { [unowned self] _ in
                    self.alertController?.dismiss(animated: true)
                }
                alert.show()
            }
